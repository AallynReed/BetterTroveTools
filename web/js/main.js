...
window.BTT_VIEW_SCRIPTS = {
    ...
    modder_tools: [
        ...
        // Desktop only: web builds have no Blueprint Editor tab, and Android strips these files.
        ...(window.BTT_WEB_MODE === true ? [] : [
            'js/modder_tools/blueprint_editor/voxel_mesh.js',
            'js/modder_tools/blueprint_editor/viewer_stage.js',
            'js/modder_tools/blueprint_editor/voxel_scene.js',
            'js/modder_tools/blueprint_editor/anim_clips.js',
            'js/modder_tools/blueprint_editor/editor.js',
        ]),
...
// window.applyAccentColor now lives in js/accent.js — index.html loads it before
// this file, and the in-game overlay window loads it without booting the shell.
